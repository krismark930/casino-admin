...
const NewMacaoSixMark = () => import('@/views/lottery/new-macao-six-mark/index.vue')
...
export default [
  {
    ...
    children: [
      ...
      {
        path: '/new-macao-six-mark',
        component: NewMacaoSixMark,
        name: 'newMacaoSixMark',
        meta: {
          title: 'menu.newMacaoSixMark',
          affix: true,
        },
      },
      {
