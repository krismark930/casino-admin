<template>
    <el-card shadow="never">
        ...
        <el-dialog v-model="newCompanyDialogVisible">
            <el-form-item label="股東 管理 --新增 ,修改">
            ...
            <el-form label-width="150">
                <el-form-item :label="`總代理  帳號 : ${newCompanyData.UserName}`">
        ...
        <el-dialog v-model="detailCompanyDialogVisible" width="90%">
            <div style="display: flex;">
                總代理  -- 詳細設定&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;帳號:{{detailCompanyData.UserName}} -- 名稱:{{detailCompanyData.Alias}} 
            </div>
...
const addCompany = async () => {
    ...
    if (newCompanyData.value.UserName == "cdm" || newCompanyData.value.UserName.length < 6) {
        alert("請輸入:總代理 帳號 !!");
        return;
    }
...
const handleChangeNumber = () => {
    newCompanyData.value.UserName = "cdm";
