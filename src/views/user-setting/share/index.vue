<template>
    <el-card shadow="never">
        ...
        <el-table :data="companyList" v-loading="loading" border header-align="center" stripe>
            ...
            <el-table-column prop="UserName" label="股東 帐号" width="140">
                <template #default="scope">
        ...
        <el-dialog v-model="newCompanyDialogVisible">
            ...
            <el-form label-width="150">
                <el-form-item :label="`股東 帳號 : ${newCompanyData.UserName}`">
            ...
            <el-form label-width="150">
                ...
                <el-form-item label="股東 佔成數 :">
                    <el-input style="width: 200px;" v-model="newCompanyData.winloss_b"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog v-model="editCompanyDialogVisible">
            ...
            <el-form label-width="150">
                ...
                <el-form-item label="股東 联系电话:">
                {{editCompanyData.Phone}}
                </el-form-item>
                <el-form-item label="股東 开户行 :">
                {{editCompanyData.Bank_Address}}
                </el-form-item>
                <el-form-item label="股東 银行账号 :">
        ...
        <el-dialog v-model="detailCompanyDialogVisible" width="90%">
            <div style="display: flex;">
                股東 -- 詳細設定&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;帳號:{{detailCompanyData.UserName}} -- 名稱:{{detailCompanyData.Alias}} 
            </div>
...
const addCompany = async () => {
    ...
    if (newCompanyData.value.UserName == "bdm" || newCompanyData.value.UserName.length < 6) {
        alert("請輸入:股東帳號 !!");
        return;
    }
...
const handleChangeNumber = () => {
    newCompanyData.value.UserName = "bdm";
