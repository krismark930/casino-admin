<template>
  <el-row style="display: flex; justify-content: space-between;">
    <b1>{{ class2 }} 赔率设置</b1>
    <div class="flex">
      <el-button size="small" @click="getRateClass2('五不中')" :type="[class2 == '五不中' ? 'primary' : '']">
        <el-icon>
          <Plus />
        </el-icon>
        五不中
      </el-button>
      <el-button size="small" @click="getRateClass2('六不中')" :type="[class2 == '六不中' ? 'primary' : '']">
        <el-icon>
          <Plus />
        </el-icon>
        六不中
      </el-button>
      <el-button size="small" @click="getRateClass2('七不中')" :type="[class2 == '七不中' ? 'primary' : '']">
        <el-icon>
          <Plus />
        </el-icon>
        七不中
      </el-button>
      <el-button size="small" @click="getRateClass2('八不中')" :type="[class2 == '八不中' ? 'primary' : '']">
        <el-icon>
          <Plus />
        </el-icon>
        八不中
      </el-button>
      <el-button size="small" @click="getRateClass2('九不中')" :type="[class2 == '九不中' ? 'primary' : '']">
        <el-icon>
          <Plus />
        </el-icon>
        九不中
      </el-button>
      <el-button size="small" @click="getRateClass2('十不中')" :type="[class2 == '十不中' ? 'primary' : '']">
        <el-icon>
          <Plus />
        </el-icon>
        十不中
        ...
        <tbody>
          <tr v-for="n in 10" :key="n" v-if="mainData.length > 0">
            <template v-for="m in 5" :key="m">
                  ...
                  <div style="display: flex; column-gap: 10px;">
                    <div>
                      <el-input-number v-model="mainData[n + (m - 1) * 10 - 1].rate" size="small"
                        controls-position="right" :step="0.1" :min="0" />
                    </div>
              ...
              <template v-else>
                <td colspan="2">
                  <el-button size="small" type="primary" @click="submitMainRate">提交</el-button>
                </td>
                <td colspan="2">
