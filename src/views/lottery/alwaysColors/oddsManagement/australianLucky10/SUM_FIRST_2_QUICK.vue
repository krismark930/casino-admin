    ...
    <el-row class="scrollbar-flex-content">
        <table class="TwoSide-table" v-if="odds1 != null">
          ...
          <tr>
              ...
              <td>12</td>
              <td>
                  <el-input v-model="odds1.h10" />
              </td>
              <td>13</td>
              <td>
                  <el-input v-model="odds1.h11" />
              </td>
              <td>14</td>
              <td>
                  <el-input v-model="odds1.h12" />
              </td>
          </tr>
          <tr>
              <td>15</td>
              <td>
                  <el-input v-model="odds1.h13" />
              </td>
              <td>16</td>
              <td>
                  <el-input v-model="odds1.h14" />
              </td>
              <td>17</td>
              <td>
                  <el-input v-model="odds1.h15" />
              </td>
              <td>18</td>
              <td>
                  <el-input v-model="odds1.h16" />
              </td>
          </tr>
          <tr>
              <td>19</td>
              <td>
                  <el-input v-model="odds1.h17" />
              </td>
          </tr>
          <tr>
              <td>和大</td>
              <td>
                  <el-input v-model="odds1.h18" />
              </td>
              <td>和小</td>
              <td>
                  <el-input v-model="odds1.h19" />
              </td>
              <td>和单</td>
              <td>
                  <el-input v-model="odds1.h20" />
              </td>
              <td>和双</td>
              <td>
                  <el-input v-model="odds1.h21" />
              </td>
          </tr>
        </table>
    </el-row>
