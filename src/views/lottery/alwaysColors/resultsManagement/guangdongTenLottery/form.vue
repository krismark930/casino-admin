...
export default {
  ...
  setup() {
    const { dispatchGetResultById } = gdsfResultStore();
    const { dispatchSaveLotteryResult } = gdsfResultStore();
    const { dispatchResultItemInitial } = gdsfResultStore();
    return {
  ...
  computed: {
    lotteryResultItem: function () {
      const { getLotteryResultData } = gdsfResultStore();
    ...
    errMessage: function () {
      const { getErrMessage } = gdsfResultStore();
