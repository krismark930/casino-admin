<template>
  <el-row justify="space-between">
    ...
    <el-col>
      <div class="flex">
        <el-button size="small" @click="getDataByClass2('二尾连中')">
          <el-icon><Plus /></el-icon>
          二尾连中
        </el-button>     
        <el-button size="small" @click="getDataByClass2('三尾连中')">
          <el-icon><Plus /></el-icon>
          三尾连中
        </el-button>
        <el-button size="small" @click="getDataByClass2('四尾连中')">
          <el-icon><Plus /></el-icon>
          四尾连中
        </el-button>
        <el-button size="small" @click="getDataByClass2('二尾连不中')">
          <el-icon><Plus /></el-icon>
          二尾连不中
        </el-button>
        <el-button size="small" @click="getDataByClass2('三尾连不中')">
          <el-icon><Plus /></el-icon>
          三尾连不中
        </el-button>
        <el-button size="small" @click="getDataByClass2('四尾连不中')">
          <el-icon><Plus /></el-icon>
          四尾连不中
        </el-button>
      </div>
...
const { dispatchGetOneXiao } = instantBetStore();
...
const getDataByClass2 = async (data) => {
  ...
  await dispatchGetOneXiao({ period: selectedPeriod.value, class1: "尾数连", class2: class2.value });
  loading.close();  
}
