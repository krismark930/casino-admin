<template>
  <el-row justify="space-between">
    ...
    <el-col>
      <div class="flex">
        <el-button size="small" @click="getDataByClass2('二肖连中')">
          <el-icon><Plus /></el-icon>
          二肖连中
        </el-button>     
        <el-button size="small" @click="getDataByClass2('三肖连中')">
          <el-icon><Plus /></el-icon>
          三肖连中
        </el-button>
        <el-button size="small" @click="getDataByClass2('四肖连中')">
          <el-icon><Plus /></el-icon>
          四肖连中
        </el-button>
        <el-button size="small" @click="getDataByClass2('五肖连中')">
          <el-icon><Plus /></el-icon>
          五肖连中
        </el-button>
        <el-button size="small" @click="getDataByClass2('二肖连不中')">
          <el-icon><Plus /></el-icon>
          二肖连不中
        </el-button>
        <el-button size="small" @click="getDataByClass2('三肖连不中')">
          <el-icon><Plus /></el-icon>
          三肖连不中
        </el-button>
        <el-button size="small" @click="getDataByClass2('四肖连不中')">
          <el-icon><Plus /></el-icon>
          四肖连不中
        </el-button>
      </div>
...
const getDataByClass2 = async (data) => {
  ...
  await dispatchGetPass({ period: selectedPeriod.value, class1: "生肖连", class2: class2.value });
  loading.close();  
}
