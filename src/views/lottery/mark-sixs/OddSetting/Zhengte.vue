<template>
  <el-row style="display: flex; justify-content: space-between;">
    <h4>{{ class2 }}赔率设置</h4>
    <div class="flex">
      <el-button size="small" :type="[class2 == '正1特' ? 'primary' : '']" @click="getRateClass2('正1特')">
        <el-icon>
          <Plus />
        </el-icon>
        正1特
      </el-button>
      <el-button size="small" :type="[class2 == '正2特' ? 'primary' : '']" @click="getRateClass2('正2特')">
        <el-icon>
          <Plus />
        </el-icon>
        正2特
      </el-button>
      <el-button size="small" :type="[class2 == '正3特' ? 'primary' : '']" @click="getRateClass2('正3特')">
        <el-icon>
          <Plus />
        </el-icon>
        正3特
      </el-button>
      <el-button size="small" :type="[class2 == '正4特' ? 'primary' : '']" @click="getRateClass2('正4特')">
        <el-icon>
          <Plus />
        </el-icon>
        正4特
      </el-button>
      <el-button size="small" :type="[class2 == '正5特' ? 'primary' : '']" @click="getRateClass2('正5特')">
        <el-icon>
          <Plus />
        </el-icon>
        正5特
      </el-button>
      <el-button size="small" :type="[class2 == '正6特' ? 'primary' : '']" @click="getRateClass2('正6特')">
        <el-icon>
          <Plus />
        </el-icon>
        正6特
...
const getRateClass2 = async (value) => {
  ...
  await dispatchSpecialCodeRate({ class1: class1.value, class2: value });
  loading.close();
}
...
const submitPlusRate = async () => {
  ...
  await dispatchPlusRate({ class1: class1.value, class2: class2.value, class3: class3, value: value })
  await dispatchSpecialCodeRate({ class1: class1.value, class2: class2.value });
  loading.close();
}
...
const submitOtherRate = async () => {
  ...
  await dispatchOtherRate({ class1: class1.value, class2: class2.value, class3: class3, rate: otherRate.value })
  await dispatchSpecialCodeRate({ class1: class1.value, class2: class2.value });
  loading.close();
}
