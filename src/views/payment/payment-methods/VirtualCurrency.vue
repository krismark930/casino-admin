  ...
  <el-scrollbar>
    <el-row class="scrollbar-flex-content">
      <table class="paymentmethod-table">
        ...
        <tbody>
          <tr>
            <td style="color:red">启用</td>
            <td>0</td>
            <td>/app/member/kkpay</td>
            <td>KK_AGENT_246001</td>
            <td>USDT</td>
            <td>hy290f9fm9di1q0uqqv8rkdkkxvr19nh6bb</td>
            <td>
              <el-select placeholder="虚拟货币">
          ...
          <tr>
            <td></td>
            <td>0</td>
            <td>http://vip.pj6678.com/app/member/xinhaipay</td>
            <td>123456</td>
            <td>鑫海(火币)</td>
            <td>c0500ea7c61e7b61ab22fb6925e78175</td>
            <td>
              <el-select placeholder="虚拟货币">
                <el-option label="网银" value="1" />
                <el-option label="微信" value="2" />
